    ...
    const [messages, setMessages] = useState<ChatMessage[]>([
        {
            role: "assistant",
            content:
                "Ohayo! I'm your Anime Sensei. Ask me anything about the universe of anime! Looking for something gritty or perhaps a wholesome slice of life?",
        },
    ]);
      ...
      `}</style>
            ...
            <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative group flex justify-center lg:justify-start order-2 lg:order-1 cursor-pointer perspective-1000">
                    ...
                    <div
                        className={`absolute -inset-12 bg-gradient-to-r from-pink-500/20 to-purple-500/20 blur-[100px] transition-all duration-700 ${
                            isLoading
                                ? "animate-think-glow opacity-100"
                                : "opacity-30 group-hover:opacity-100 group-hover:from-pink-500/40 group-hover:to-purple-500/40 group-hover:blur-[140px]"
                        }`}
                    />
                    ...
                    <div className="relative w-full max-w-sm aspect-[3/4] rounded-3xl overflow-hidden border border-white/5 shadow-2xl animate-subtle-float transition-all duration-700 ease-out group-hover:scale-[1.06] group-hover:rotate-1 group-hover:shadow-[0_0_60px_rgba(236,72,153,0.25)]">
                        <img
                            src="https://bom.edu.vn/public/upload/2024/12/avatar-anime-nu-4.webp?auto=format&fit=crop&q=80&w=800"
                            alt="AI Assistant"
                            className={`w-full h-full object-cover grayscale-[15%] transition-all duration-1000 animate-breathing ${
                                isLoading
                                    ? "scale-105 saturate-[1.1] grayscale-0"
                ...
                <div className="flex flex-col h-[600px] glass rounded-3xl overflow-hidden border border-white/5 order-1 lg:order-2 shadow-2xl">
                    <div className="p-6 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                        <div className="flex items-center gap-3">
                            ...
                            <h3 className="font-anime font-bold text-lg tracking-[0.2em] uppercase">
                                AI CONCIERGE
                            </h3>
                        </div>
                        <button
                        ...
                        {messages.map((msg, idx) => (
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div
                                        className={`p-4 rounded-2xl text-[13px] leading-relaxed shadow-xl ${
                                            msg.role === "user"
