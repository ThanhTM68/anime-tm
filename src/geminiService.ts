...
export async function analyzeAnime(animeTitle: string): Promise<string> {
    try {
        ...
        const response = await ai.models.generateContent({
            ...
            contents: [
                {
                    ...
                    parts: [
                        {
                            text: `Phân tích chuyên sâu về anime này cho tôi: ${animeTitle}`,
                        },
                    ],
                },
            ],
            config: {
                systemInstruction:
                    "Bạn là Sensei AI, một chuyên gia phân tích anime. Trả lời bằng tiếng Việt, ngắn gọn, súc tích và có chút phong cách Cyberpunk.",
            },
        });
...
export async function getAnimeRecommendations(prompt: string): Promise<string> {
    try {
        ...
        const response = await ai.models.generateContent({
            ...
            config: {
                systemInstruction:
                    "Bạn là Sensei-AI. Trả lời bằng tiếng Việt, thân thiện, am hiểu về anime và manga. Phong cách nói chuyện của bạn hiện đại, pha chút yếu tố công nghệ tương lai.",
            },
        });
